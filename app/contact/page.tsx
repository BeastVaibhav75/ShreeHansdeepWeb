            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-wood-100 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                    <svg className="w-6 h-6 text-wood-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <a href="tel:01274261129" className="text-wood-700 hover:text-wood-800 block">
                        01274-261129
                      </a>
                      <a href="tel:+919812125410" className="text-wood-700 hover:text-wood-800 block">
                        +91 98121 25410
                      </a>
                      <a href="tel:+919466022823" className="text-wood-700 hover:text-wood-800 block">
                        +91 94660 22823
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:shreehansdeep94@gmail.com" className="text-wood-700 hover:text-wood-800">
